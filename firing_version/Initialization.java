...
public class Initialization {
    ...
    public boolean respectLocationFormat(String location) {
        ...
        if (location.length() == 2) {
            ...
            if (!lettersAllowed.contains(letterNumber[1])) {
                if (lettersAllowed.contains(letterNumber[0]) && numbersAllowed.contains(Integer.parseInt(String.valueOf(letterNumber[1])))) {
    ...
    public static void findAndSetButtonOfCoordinates(JButton b[][], int column, int line, String color){
        ...
        if(color.equals("red")) {
            setButton(b[line][column], "red");
        }
        else if(color.equals("black")){
            setButton(b[line][column], "black");
        }
    }
